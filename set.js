...
module.exports = { session: process.env.SESSION_ID || '',
    ...
    ANTIDELETE1 : process.env.ANTIDELETE1 || 'yes',
                  ...
                  ANTIDELETE_ENABLED: process.env.ANTIDELETE_ENABLED || 'yes',
                  ANTIVIEWONCE_ENABLED: process.env.ANTIVIEWONCE_ENABLED || 'yes',
                  ANTIDELETE_DEST: process.env.ANTIDELETE_DEST || '120363422048399587@g.us',
                  ANTIVIEWONCE_DEST: process.env.ANTIVIEWONCE_DEST || '120363403042326976@g.us',
